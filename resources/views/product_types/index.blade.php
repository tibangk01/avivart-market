                                                ...
                                                @if ($productTypes->count() > 0)
                                                    @foreach ($productTypes as $productType)
                                                        <tr>
                                                            ...
                                                            <td>{{ $productType->created_at }}</td>
                                                            <td>
                                                                <a class="btn btn-info btn-xs" href="{{ route('product_type.show', $productType) }}"
                                                                    title="Afficher"><i class="fa fa-eye"
                                                                        aria-hidden="true"></i></a>
                                                                <a class="btn btn-warning btn-xs" href="{{ route('product_type.edit', $productType) }}"
                                                                    title="Afficher"><i class="fa fa-edit"
                                                                        aria-hidden="true"></i></a>
                                                                <a class="btn btn-danger btn-xs" href="{{ route('product_type.destroy',$productType) }}"
...
=======
@endsection
>>>>>>> bbf32a11c95b12a01ab8dd412f6782dd72375f28
