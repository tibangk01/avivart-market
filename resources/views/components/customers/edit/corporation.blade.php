<div>
    ...
    <div class="form-group">
        ...
        {!! Form::select('country_id', $countries, $customer->corporation->enterprise->country_id, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Choisissez']) !!}
    </div>

    <div class="form-group">
        {!! Form::label('region_id', 'Région') !!}
        {!! Form::select('region_id', $regions, $customer->corporation->enterprise->region_id, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Choisissez']) !!}
    </div>
