...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark-primary navbar-light border-bottom-0 text-sm">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../index3.html" class="nav-link">Personnels & Collaborateurs</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../index3.html" class="nav-link">Documents Commerciaux</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../index3.html" class="nav-link">Ventes</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../index3.html" class="nav-link">Stocks</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../index3.html" class="nav-link">Paramétrages</a>
      </li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-1 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <span class="btn btn-xs btn-danger">Déconnexion</span> &nbsp; <span class="text-white">|</span> &nbsp;
          <span class="btn btn-xs btn-success">Profil</span>
        </div>
      </div>
